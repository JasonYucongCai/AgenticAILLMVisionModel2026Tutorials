...
![License: Apache 2.0 + HCASL v0.2](https://img.shields.io/badge/license-Apache%202.0%20%2B%20HCASL%20v0.2-blue)
![Version](https://img.shields.io/badge/version-v0.0.2-lightgrey)
![Notebooks](https://img.shields.io/badge/notebooks-16-orange)

A rebuilt, GitHub-friendly course of **16 Jupyter notebooks** covering the full path
from **LLM transformer training** → **Agentic AI** → **Vision-Language models &
specific applications** → **classical computer vision**.

The original notebooks are kept untouched in
[`assets/previous-resources/`](assets/previous-resources/) as an immutable archive
(log). This folder contains the **rebuilt (v0.0.2)** copies with fixed code, portable
...
- [Rebuild notes](#rebuild-notes-v002)
...
|---|--------|--------|-----------|----------|
| 01 | LLM Transformer Training | `tutorials/01-llm-transformer-training/` | 3 | GPU (7B for FSDP) |
| 02 | Agentic AI | `tutorials/02-agentic-ai/` | 4 | DeepSeek API key |
| 03 | Vision-Language & Specific Applications | `tutorials/03-vision-language-applications/` | 3 | GPU (VLM) / API key |
| 04 | Classical Computer Vision | `tutorials/04-classical-computer-vision/` | 6 | GPU recommended |

### 01 — LLM Transformer Training (`tutorials/01-llm-transformer-training/`)
...
### 02 — Agentic AI (`tutorials/02-agentic-ai/`)
...
### 03 — Vision-Language & Specific Applications (`tutorials/03-vision-language-applications/`)
...
### 04 — Classical Computer Vision (`tutorials/04-classical-computer-vision/`)
...
pip install -r tutorials/01-llm-transformer-training/requirements.txt
pip install -r tutorials/02-agentic-ai/requirements.txt
pip install -r tutorials/03-vision-language-applications/requirements.txt
pip install -r tutorials/04-classical-computer-vision/requirements.txt
```
...
| Version | Date | Change |
|---|---|---|
| v0.0.2 | 2026-08-03 | Fixed `01-LoRA-FineTuning.ipynb`: EOS stop-signal bug (trailing R1 boilerplate), self-contained diagnostics/imports, robust inference parsing. Details below. |
| v0.0.1 | 2026-08-03 | Initial rebuild of the 4-series course from `assets/previous-resources/` (archive kept untouched). |
...
### v0.0.1 file mapping (archive → rebuild)

| Archive file (`assets/previous-resources/`) | Rebuilt file (`tutorials/`) |
|---|---|
| `20260331 LoRA_FineTuning_English_No_SCNet (Upload).ipynb` | `tutorials/01-llm-transformer-training/01-LoRA-FineTuning.ipynb` |
| `20260401 FSDP_LoRA_FineTuning_English (upload).ipynb` | `tutorials/01-llm-transformer-training/02-FSDP-LoRA-MultiGPU.ipynb` |
| `20260401 GPT2_like_training_English (upload).ipynb` | `tutorials/01-llm-transformer-training/03-GPT2-like-Training.ipynb` |
| `20260404 openai_sdk_agentic_ai_asyncopenai_agent_en (upload).ipynb` | `tutorials/02-agentic-ai/01-AsyncOpenAI-Agent-Basics.ipynb` |
| `20260405 OpenAI_SDK_Agentic_AI_WebSearch_Agent_English (upload).ipynb` | `tutorials/02-agentic-ai/02-WebSearch-Agent.ipynb` |
| `20260412 agentic_ai_openai_sdk (upload).ipynb` | `tutorials/02-agentic-ai/03-Handoff-and-as_tool.ipynb` |
| `20260413 replacement_01_translated_en (upload).ipynb` | `tutorials/02-agentic-ai/04-Replacement-01-MultiAgent.ipynb` |
| `20260411 DeepSeek_CLIP_VLM_English_Tutorial (upload).ipynb` | `tutorials/03-vision-language-applications/01-DeepSeek-CLIP-VLM.ipynb` |
| `20260413 rag_embedding_english_notebook (upload).ipynb` | `tutorials/03-vision-language-applications/02-RAG-Embedding.ipynb` |
| `20260403 scnet_deepseek_api_gradio_en (Upload).ipynb` | `tutorials/03-vision-language-applications/03-DeepSeek-API-Gradio.ipynb` |
| `20260402 cifar10_cnn_english_notebook (upload).ipynb` | `tutorials/04-classical-computer-vision/01-CIFAR10-CNN.ipynb` |
| `20260403 vgg19_cifar100_transfer_learning_en (upload).ipynb` | `tutorials/04-classical-computer-vision/02-VGG19-CIFAR100-TransferLearning.ipynb` |
| `20260406 faster_rcnn_voc_transfer_learning_en (upload).ipynb` | `tutorials/04-classical-computer-vision/03-FasterRCNN-VOC.ipynb` |
| `20260407 unet_pascal_voc_notebook (upload).ipynb` | `tutorials/04-classical-computer-vision/04-UNet-VOC-Segmentation.ipynb` |
| `20260408 Vision_Transformer_PASCAL_VOC_Classification_English (upload).ipynb` | `tutorials/04-classical-computer-vision/05-ViT-VOC-Classification.ipynb` |
| `20260409 Modular_Network_Assembly_Vision_Transformer_RoPE_SOT_LaSOT_en (upload).ipynb` | `tutorials/04-classical-computer-vision/06-ViT-RoPE-SOT-LaSOT.ipynb` |

### v0.0.1 changes per notebook
...
### v0.0.2 changes (2026-08-03) — `01-LoRA-FineTuning.ipynb`
